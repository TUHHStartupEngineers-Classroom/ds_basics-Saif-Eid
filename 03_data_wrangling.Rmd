...
```
# Data Wrangling (Alternative 2 - Reduced Data)
## First Question
### Top ten organizations with most patents in the US
...
## Second Question
### Top ten organizations with most patents in the US in August 2014
...
## Third Question
### Top five patent types for the top ten organizations patentwise worldwide
...
M_100 <- M_10[1:5]
```
Note: In the above code, regarding the last question, the top 5 mainclass_id for the top ten organizations were extracted manually (a function was created at the beginning to reduce the code, but the data wasn't quite right, so I figured to do each company manually).